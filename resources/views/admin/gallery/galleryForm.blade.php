...
@section('content')
    <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            ...
                            <input name="title" type="text" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="{{__('Title')}}" value="{{old('title',$gallery->title??null)}}"  />
                        </div>
                    </div>
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="{{__('Description')}}"   rows="3">{{old('description',$gallery->description??null)}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="form-group">
                            ...
                            <input name="image" type="file" class="form-control-file @error('image') is-invalid @enderror" placeholder="{{__('Index image')}}" value="{{old('image',$gallery->image??null)}}"  />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label> &nbsp; </label>
        ...
        @if (isset($gallery))
            ...
            <form class="card mt-3" method="post" enctype="multipart/form-data" action="{{route('admin.image.store',$gallery->slug)}}">
                @csrf
                <div class="card-header">
